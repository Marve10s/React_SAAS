  ...
  return (
    <section className="container text-center section flex flex-col">
      ...
      <h2 className="mt-5 text-gray-600 sm:text-xl">
        Nexx is a SaaS platform that allows you to launch your SaaS in minutes
        not days.
      </h2>
      <div className="mx-auto mt-5 flex max-w-fit space-x-4">
        ...
        <a
          href="#features"
          className="rounded-full mx-auto max-w-fit border px-5 py-2 text-sm font-medium shadow-sm border-gray-300 bg-white text-black hover:ring-gray-400 hover:ring-2"
        >
          Learn More
        </a>
      </div>
